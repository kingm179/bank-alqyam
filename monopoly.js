// اخر حاجة انا وقفت فيها هنا كانت اني عملت مجموعة فنكشن واستعدعيتهم جوه بعض واخر فنكشن بتاعت الاظهار والاخقاء استدعتها جوه الفنكشن بتاعت المكان عشان شراء البيوت يشتغل صح
...
function Game() {
	...
	var finalizeAuction = function() {
		...
		if (highestbid > 0) {
			...
			addAlert(p.name + " اشتري " + sq.name + " مقابل جنيه" + highestbid + ".");
		}
...
function updatePosition() {
	...
	for (var i = turn; i <= pcount; i++) {
		if (player[i].jail) {
			document.getElementById("jailpositionholder").innerHTML += "<div class='cell-position' title='" + player[i].name + "' style='background-color: " + player[i].color + "; left: " + left + "px; bottom: " + top + "px;'></div>";
...
function updateMoney() {
	...
	document.getElementById("pmoney").innerHTML = "Le" + p.money;
	$(".money-bar-row").hide();
...
function chanceCommunityChest() {
	...
	if (p.position === 2 || p.position === 17 || p.position === 33) {
		...
		popup("<img src='images/community_chest_icon.png' style='height: 50px; width:top:; float: left; margin: 8px 8px 8px 0px;' /><div style='font-weight: bold; font-size: 16px; '>Community Chest:</div><div style='text-align: justify;'>" + communityChestCards[communityChestIndex].text + "</div>", function() {
	...
	// Chance
		...
		popup("<img src='images/chance_icon.png' style='height: 50px; width: 26px; float: left; margin: 8px 8px 8px 0px;' /><div style='font-weight: bold; font-size: 16px; '>حظك:</div><div style='text-align: justify;'>" + chanceCards[chanceIndex].text + "</div>", function() {
...
function buy() {
	...
	if (p.money >= cost) {
		...
		property.owner = turn;
		updateMoney();
		addAlert(p.name + " اشتري " + property.name + " مقابل " + property.pricetext + ".");
...
function land(increasedRent) {
	...
	$("#landed").show();
	document.getElementById("landed").innerHTML = "لقد استعملت قيمة  " + s.name + ".";
	s.landcount++;
	hideandshow();
	addAlert(p.name + " توقف على " + s.name + ".");
...
// مكان اللاعب
	...
	if (s.price !== 0 && s.owner === 0) {
		...
		if (!p.human) {
			...
			document.getElementById("questioncheck").innerHTML = "<div id = 'tesst'><a href='javascript:void(0);' onmouseover='showdeed("  + ");' onmouseout='hidedeed();' class='statscellcolor'>"  + "</a><input type='button' id='CheckButton' onclick='buy();' value='شراء  (" +s.name+" ب"+ s.price + " جنيه)' title='Buy " + s.name + " for " + s.pricetext + ".'/></div>";
			document.getElementById("landed").innerHTML = "<div id = 'mohamed'>  <a href='javascript:void(0);' onmouseover='showdeed(" + p.position + ");' onmouseout='hidedeed();' class='statscellcolor'>" + s.name + "</a><input type='button' id='BuyButton' onclick='results();' value=' اجب على السؤال  لتستطيع شراء مدينة"+"' title='Buy "+ " for " + s.pricetext + "'/> </div>";
	...
	if (s.owner !== 0 && s.owner != turn && !s.mortgage) {
		...
		document.getElementById("landed").innerHTML = "لقد توقفت في   " + s.name + ". " + player[s.owner].name + " collected $" + rent + " rent.";
	} else if (s.owner > 0 && s.owner != turn && s.mortgage) {
		document.getElementById("landed").innerHTML = "لقد استعملت قيمة " + s.name + ". القيمة متبرع بها لله لا تدفع ايجار.";
	}
...
function closechoices(){
	var p = player[turn].position;
	switch(p){
	case 1:
	document.getElementById("Alnzam").style.display = "none";
	break;
	case 3:
	document.getElementById("shkar-alnam").style.display = "none";
	break;
	case 6:
	document.getElementById("Altwada").style.display = "none";
	break;
	case 8:
	document.getElementById("Alahtram").style.display = "none";
	break;
	case 9:
	document.getElementById("almomla").style.display = "none";
	break;
	case 11:
	document.getElementById("amna").style.display = "none";
	break;
	case 13:
	document.getElementById("bralwalden").style.display = "none";
	break;
	case 14:
		document.getElementById("yaken").style.display = "none";
		break;
	case 16:
		document.getElementById("alrhma").style.display = "none";
		break;
	case 18:
		document.getElementById("tsmah").style.display = "none";
		break;
	case 19:
		document.getElementById("satr").style.display = "none";
		break;
	case 21:
		document.getElementById("aklak").style.display = "none";
		break;
	case 23:
		document.getElementById("ahsan").style.display = "none";
		break;
	case 24:
		document.getElementById("aysar").style.display = "none";
		break;
	case 26:
		document.getElementById("karm").style.display = "none";
		break;
	case 27:
		document.getElementById("sharf").style.display = "none";
		break;
	case 29:
		document.getElementById("helpothers").style.display = "none";
		break;
	case 31:
		document.getElementById("afw").style.display = "none";
		break;
	case 32:
		document.getElementById("tqwa").style.display = "none";
		break;
	case 34:
		document.getElementById("sabr").style.display = "none";
		break;
	case 37:
		document.getElementById("shkar").style.display = "none";
		break;
	case 39:
		document.getElementById("relationwithallah").style.display = "none";
		break;
...
function display1 (){
	...
	break;
	case 3:
		var e = document.getElementById("shkar-alnam-result").value;
		if (e == 2){
			document.getElementById("questioncheck").style.display = "block";
			document.getElementById("landed").style.display = "none";
			break;
		...
		break;
	case 6:
		var e = document.getElementById("Altwada-result").value;
	if (e == 2){
		document.getElementById("questioncheck").style.display = "block";
		document.getElementById("landed").style.display = "none";
		break;
	...
	break;
	case 8:
		var e = document.getElementById("Alahtram-result").value;
		if (e == 2){
			document.getElementById("questioncheck").style.display = "block";
			document.getElementById("landed").style.display = "none";
			break;
		...
		break;
	case 9:
		var e = document.getElementById("almomla-result").value;
		if (e == 2){
			document.getElementById("questioncheck").style.display = "block";
			document.getElementById("landed").style.display = "none";
			break;
		...
		break;
	case 11:
		var e = document.getElementById("amna-result").value;
		if (e == 2){
			document.getElementById("questioncheck").style.display = "block";
			document.getElementById("landed").style.display = "none";
			break;
		...
		break;
	case 13:
		var e = document.getElementById("bralwalden-result").value;
		if (e == 2){
			document.getElementById("questioncheck").style.display = "block";
			document.getElementById("landed").style.display = "none";
			break;
		...
		break;
	case 14 :
			var e = document.getElementById("yaken-result").value;
			if (e == 2){
				document.getElementById("questioncheck").style.display = "block";
				document.getElementById("landed").style.display = "none";
				break;
			...
			break;
	case 16 :
			var e = document.getElementById("alrhma-result").value;
			if (e == 2){
				document.getElementById("questioncheck").style.display = "block";
				document.getElementById("landed").style.display = "none";
				break;
			...
			break;
	case 18 :
			var e = document.getElementById("tsmah-result").value;
			if (e == 2){
				document.getElementById("questioncheck").style.display = "block";
				document.getElementById("landed").style.display = "none";
				break;
			...
			break;
	case 19:
			var e = document.getElementById("satr-result").value;
			if (e == 2){
				document.getElementById("questioncheck").style.display = "block";
				document.getElementById("landed").style.display = "none";
				break;
			...
			break;
	case 21:
			var e = document.getElementById("aklak-result").value;
			if (e == 2){
				document.getElementById("questioncheck").style.display = "block";
				document.getElementById("landed").style.display = "none";
				break;
			...
			break;
	case 23:
				var e = document.getElementById("ahsan-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 24:
				var e = document.getElementById("aysar-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 26:
				var e = document.getElementById("karm-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 27:
				var e = document.getElementById("sharf-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 29:
				var e = document.getElementById("helpothers-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 31:
				var e = document.getElementById("afw-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 32:
				var e = document.getElementById("tqwa-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 34:
				var e = document.getElementById("sabr-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 37:
				var e = document.getElementById("shkar-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
				...
				break;
	case 39:
				var e = document.getElementById("relationwithallah-result").value;
				if (e == 2){
					document.getElementById("questioncheck").style.display = "block";
					document.getElementById("landed").style.display = "none";
					break;
...
function results(){
	document.getElementById("mohamed").hidden = true;
	var p = player[turn].position;
	switch(p){
	case 1:
	document.getElementById("Alnzam").style.display = "block";
	var myelement = document.getElementById('Alnzam');
	...
	break;
	case 3:
		document.getElementById("shkar-alnam").style.display = "block";
	var myelement = document.getElementById('shkar-alnam');
	...
	break;
	case 6:
		document.getElementById("Altwada").style.display = "block";
	var myelement = document.getElementById('Altwada');
	...
	break;
	case 8:
		document.getElementById("Alahtram").style.display = "block";
	var myelement = document.getElementById('Alahtram');
	...
	break;
	case 9:
		document.getElementById("almomla").style.display = "block";
	var myelement = document.getElementById('almomla');
	...
	break;
	case 11:
		document.getElementById("amna").style.display = "block";
	var myelement = document.getElementById('amna');
	...
	break;
	case 13:
		document.getElementById("bralwalden").style.display = "block";
	var myelement = document.getElementById('bralwalden');
	...
	break;
	case 14:
		document.getElementById("yaken").style.display = "block";
	var myelement = document.getElementById('yaken');
	...
	break;
	case 16:
		document.getElementById("alrhma").style.display = "block";
	var myelement = document.getElementById('alrhma');
	...
	break;
	case 18:
		document.getElementById("tsmah").style.display = "block";
	var myelement = document.getElementById('tsmah');
	...
	break;
	case 19:
		document.getElementById("satr").style.display = "block";
	var myelement = document.getElementById('satr');
	...
	break;
	case 21:
		document.getElementById("aklak").style.display = "block";
	var myelement = document.getElementById('aklak');
	...
	break;
	case 23:
		document.getElementById("ahsan").style.display = "block";
	var myelement = document.getElementById('ahsan');
	...
	break;
	case 24:
		document.getElementById("aysar").style.display = "block";
	var myelement = document.getElementById('aysar');
	...
	break;
	case 26:
		document.getElementById("karm").style.display = "block";
	var myelement = document.getElementById('karm');
	...
	break;
	case 27:
		document.getElementById("sharf").style.display = "block";
	var myelement = document.getElementById('sharf');
	...
	break;
	case 29:
		document.getElementById("helpothers").style.display = "block";
	var myelement = document.getElementById('helpothers');
	...
	var myelement = document.getElementById('afw');
	...
	break;
	case 32:
		document.getElementById("tqwa").style.display = "block";
	var myelement = document.getElementById('tqwa');
	...
	break;
	case 34:
		document.getElementById("sabr").style.display = "block";
	var myelement = document.getElementById('sabr');
	...
	break;
	case 37:
		document.getElementById("shkar").style.display = "block";
	var myelement = document.getElementById('shkar');
	...
	break;
	case 39:
		document.getElementById("relationwithallah").style.display = "block";
	var myelement = document.getElementById('relationwithallah');
...
function roll() {
	...
	if (die1 == die2) {
		addAlert(p.name + " حصل على " + (die1 + die2) + " - doubles.");
	} else {
		addAlert(p.name + " حصل على " + (die1 + die2) + ".");
	}
...
function play() {
	...
	document.getElementById("nextbutton").value = "ارمي الزهر";
	document.getElementById("nextbutton").title = "ارمي الزهر وتحرك خطواتك بناء عليه ";
	...
	if (p.jail) {
		$("#landed").show();
		document.getElementById("landed").innerHTML = "You are in jail.<input type='button' title='ادفع 50 جنيه للخروج من السجن فورا.' value='ادفع 50 جنيه' onclick='payfifty();' />";
...
;
	...
	$("<span>").text("السجن").appendTo("#jail");

	document.getElementById("jail").enlargeId = "enlarge40";

	document.getElementById("enlarge-wrap").innerHTML += "<div id='enlarge40' class='enlarge'><div id='enlarge40color' class='enlarge-color'></div><br /><div id='enlarge40name' class='enlarge-name'>السجن</div><br /><div id='enlarge40price' class='enlarge-price'><img src='images/jake_icon.png' height='80' width='80' alt='' style='position: relative; top: -20px;' /></div><br /><div id='enlarge40token' class='enlarge-token'></div></div>";

	document.getElementById("enlarge40name").innerHTML = "السجن";
